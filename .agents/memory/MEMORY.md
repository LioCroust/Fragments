...
- [Skia animated transforms](skia-animated-transforms.md) — In Expo Go, use direct shared x/y props; animated matrix props can crash the Skia/Reanimated recorder.