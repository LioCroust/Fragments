...
Capture filling must classify connected EMPTY components and fill enclosed pockets; never seed the decision from one fixed center cell, because that cell can lie inside the pocket and preserve the wrong black region.